...
void CUserInterface::SetLife(int nLife)
{
	m_nNumOfLife = nLife;
}

void CUserInterface::SetScore(int nScore)
{
	m_nScore = nScore;
}

void CUserInterface::AddSpecial()
{
	++m_nNumOfSpecial;
}

void CUserInterface::SubSpecial()
{
	--m_nNumOfSpecial;
}

int CUserInterface::CalModular(int& number, int digit)
{
