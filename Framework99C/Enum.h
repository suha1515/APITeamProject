...
enum OBJECT_TYPE { OBJECT_STAGE, OBJECT_MONSTER, OBJLECT_BULLET, OBJECT_MONBULLET, OBJECT_WINGMAN,OBJECT_ITEM, OBJECT_PLAYER, OBJECT_UI, OBJECT_END };
...
enum PLAYER_BULLET_TYPE{LEVEL1,LEVEL2,LEVEL3,LEVEL4,WINGMAN,BOMBS,LEVEL_END};
...
enum EFFECT {EXPLOSIVE_1,EXPLOSIVE_2, EXPLOSIVE_3,E_HIT_EFFECT, E_END};
